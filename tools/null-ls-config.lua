...
local ltcc_code_action = null_ls_helpers.make_builtin({
	name = "ltcc",
	meta = {
		url = "https://github.com/dustinblackman/translate-comments-cpp",
		description = "translate-comments-cpp integrates the LanguageTool API to parse, spell check, and correct the grammar of your code comments!",
	},
	method = CODE_ACTION,
	filetypes = lctt_filetypes,
	generator_opts = {
		command = "translate-comments-cpp",
